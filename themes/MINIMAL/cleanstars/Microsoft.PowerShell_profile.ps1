# Profile: UTF-8 + Oh My Posh + Fastfetch (Clean Stars Theme)
try {
...
oh-my-posh init pwsh --config "D:/Repositories/MyPoshTheme/themes/MINIMAL/cleanstars/Cleanstars.omp.json" | Invoke-Expression
